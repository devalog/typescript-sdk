...
export class Imdb {
     ...
     *
     * @param {MyClientNameDevin.CreateMovieRequest} request
    ...
    ): core.HttpResponsePromise<MyClientNameDevin.MovieId> {
    ...
    private async __createMovie(
        ...
        if (_response.ok) {
            return { data: _response.body as MyClientNameDevin.MovieId, rawResponse: _response.rawResponse };
        }

        if (_response.error.reason === "status-code") {
            throw new errors.MyClientNameDevinError({
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MyClientNameDevinTimeoutError(
     ...
     *
     * @param {MyClientNameDevin.MovieId} id
     * @param {Imdb.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link MyClientNameDevin.MovieDoesNotExistError}
     *
     * @example
    ...
    public getMovie(
        ...
        requestOptions?: Imdb.RequestOptions,
    ): core.HttpResponsePromise<MyClientNameDevin.Movie> {
    ...
    private async __getMovie(
        ...
        if (_response.ok) {
            return { data: _response.body as MyClientNameDevin.Movie, rawResponse: _response.rawResponse };
        }

        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                case 404:
                    throw new MyClientNameDevin.MovieDoesNotExistError(
                        _response.error.body as MyClientNameDevin.MovieId,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MyClientNameDevinTimeoutError("Timeout exceeded when calling GET /movies/{id}.");
            case "unknown":
                throw new errors.MyClientNameDevinError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
